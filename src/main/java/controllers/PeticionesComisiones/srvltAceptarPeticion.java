 ...
 * @author cacerola
 */
@WebServlet("/aceptarPeticionComision")
public class srvltAceptarPeticion extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            servicio.aceptarPeticion(idEmpresa);
            
            response.setStatus(HttpServletResponse.SC_OK);
            response.getWriter().write("{\"exito\": true, \"mensaje\": \"Petición aceptada correctamente\"}");
            ...
            response.getWriter().write("{\"mensaje\":\"Error al aceptar la petición\"}");
            e.printStackTrace();
        }
    }
}