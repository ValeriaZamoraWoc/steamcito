 ...
 * @author cacerola
 */
@WebServlet("/admin/reporte/juegos-mas-vendidos/categoria")
public class srvltJuegosMasVendidosCategoriaAdmin extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            List<ReporteJuegosMasVendidosAdminDTO> datos =
                    service.juegosMasVendidosCategoria(categoria);

            InputStream jrxml =
                    getServletContext().getResourceAsStream(
                        "/reportes/admin/JuegosMasVendidosCategoriaAdmin.jrxml"
                    );
            ...
            response.setHeader(
                "Content-Disposition",
                "inline; filename=JuegosMasVendidosCategoriaAdmin.pdf"
            );
