 ...
 * @author cacerola
 */
@WebServlet("/admin/reporte/mejores-calificados/clasificacion")
public class srvltMejoresCalificadosClasificacionAdmin extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            List<ReporteMejoresCalificadosAdminDTO> datos =
                    service.mejoresCalificadosClasificacion(clasificacion);

            InputStream jrxml =
                    getServletContext().getResourceAsStream(
                        "/reportes/admin/MejoresCalificadosClasificacionAdmin.jrxml"
                    );
            ...
            response.setHeader(
                "Content-Disposition",
                "inline; filename=MejoresCalificadosClasificacionAdmin.pdf"
            );
