 ...
 * @author cacerola
 */
@WebServlet("/empresa/reporte/juegos-peor-calificados")
public class srvltJuegosPeorCalificadosEmpresa extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<ReporteJuegosCalificadosEmpresaDTO> datos =
                    service.obtenerJuegosPeorCalificadosEmpresa(idEmpresa);

            InputStream jrxml =
                    getServletContext().getResourceAsStream(
                        "/reportes/empresa/JuegosPeorCalificadosEmpresa.jrxml"
                    );
            ...
            response.setHeader(
                "Content-Disposition",
                "inline; filename=JuegosPeorCalificadosEmpresa.pdf"
            );
