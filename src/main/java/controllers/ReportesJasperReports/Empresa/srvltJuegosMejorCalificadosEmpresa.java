 ...
 * @author cacerola
 */
@WebServlet("/empresa/reporte/juegos-mejor-calificados")
public class srvltJuegosMejorCalificadosEmpresa extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<ReporteJuegosCalificadosEmpresaDTO> datos =
                    service.obtenerJuegosMejorCalificadosEmpresa(idEmpresa);

            InputStream jrxml =
                    getServletContext().getResourceAsStream(
                        "/reportes/empresa/JuegosMejorCalificadosEmpresa.jrxml"
                    );
            ...
            response.setHeader(
                "Content-Disposition",
                "inline; filename=JuegosMejorCalificadosEmpresa.pdf"
            );
