 ...
 * @author cacerola
 */
@WebServlet("/empresa/reporte/ventas")
public class srvltReporteVentasEmpresa extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // datos
            List<ReporteVentasEmpresaDTO> datos =
                    service.obtenerVentasEmpresa(idEmpresa);

            InputStream jrxml =
                    getServletContext().getResourceAsStream(
                        "/reportes/empresa/VentasEmpresa.jrxml"
                    );
            ...
            response.setHeader(
                "Content-Disposition",
                "inline; filename=VentasEmpresa.pdf"
            );
