 ...
 * @author cacerola
 */
@WebServlet("/usuario/reporte/juegos-mejor-calificados")
public class srvltJuegosMejorCalificadosUsuario extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            List<JuegoMejorCalificadoDTO> datos =
                    service.obtenerMejoresCalificadosBiblioteca(mail);

            InputStream jrxml =
                    getServletContext().getResourceAsStream(
                        "/reportes/usuario/JuegosMejorCalificadosUsuario.jrxml"
                    );
            ...
            response.setHeader(
                "Content-Disposition",
                "inline; filename=JuegosMejorCalificadosUsuario.pdf"
            );
