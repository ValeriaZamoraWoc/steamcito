 ...
 * @author cacerola
 */
@WebServlet("/usuario/reporte/prestados-mejor-calificados")
public class srvltPrestadosMejorCalificadosUsuario extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            List<PrestadoMejorCalificadoDTO> datos =
                    service.obtenerMejoresCalificadosPrestados(mail);

            InputStream jrxml =
                    getServletContext().getResourceAsStream(
                        "/reportes/usuario/PrestadosMejorCalificadosUsuario.jrxml"
                    );
            ...
            response.setHeader(
                "Content-Disposition",
                "inline; filename=PrestadosMejorCalificadosUsuario.pdf"
            );
