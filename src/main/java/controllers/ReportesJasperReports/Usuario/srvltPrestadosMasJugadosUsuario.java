 ...
 * @author cacerola
 */
@WebServlet("/usuario/reporte/prestados-mas-jugados")
public class srvltPrestadosMasJugadosUsuario extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            List<PrestadoMasJugadoDTO> datos =
                    service.obtenerPrestadosMasJugados(mail);

            InputStream jrxml =
                    getServletContext().getResourceAsStream(
                        "/reportes/usuario/PrestadosMasJugadosUsuario.jrxml"
                    );
            ...
            response.setHeader(
                "Content-Disposition",
                "inline; filename=PrestadosMasJugadosUsuario.pdf"
            );
