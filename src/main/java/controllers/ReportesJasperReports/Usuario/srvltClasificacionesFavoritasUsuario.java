 ...
 * @author cacerola
 */
@WebServlet("/usuario/reporte/clasificaciones-favoritas")
public class srvltClasificacionesFavoritasUsuario extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            List<ClasificacionFavoritaDTO> datos =
                    service.obtenerClasificacionesFavoritas(mail);

            InputStream jrxml =
                    getServletContext().getResourceAsStream(
                        "/reportes/usuario/ClasificacionesFavoritasUsuario.jrxml"
                    );
            ...
            response.setHeader(
                "Content-Disposition",
                "inline; filename=ClasificacionesFavoritasUsuario.pdf"
            );
